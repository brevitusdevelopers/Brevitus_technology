...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-white dark:bg-[#0a0a0a] border-t border-zinc-200 dark:border-zinc-800 transition-colors duration-300 pt-16 pb-8 px-6 mt-auto">
      <div className="max-w-7xl mx-auto flex flex-col gap-12">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 border-t border-zinc-200 dark:border-zinc-800">
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6">
            <Link href="#" className="text-zinc-500 dark:text-zinc-500 text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Privacy Policy</Link>
            <Link href="#" className="text-zinc-500 dark:text-zinc-500 text-sm font-medium hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Terms of Service</Link>
          </div>
        </div>
