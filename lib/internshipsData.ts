...
import { InternshipData } from "@/components/internships/InternshipCard";

export const internshipsData: InternshipData[] = [
  {
    id: 1,
    ...
    pdfLink: "https://ik.imagekit.io/wkqezkwpg/Site%20content/Site%20content/3_month_internship.pdf?updatedAt=1774204999353" 
  },
  {
    id: 2,
